...
if not identified_outliers_df.empty:
    ...
    # Performance Optimization: Using itertuples(index=False) instead of iterrows() for faster DataFrame iteration
                ...
                applied_corrections.append(
                    {
                        ...
                        "File_Corrected": os.path.basename(next_year_raw_file).replace(
