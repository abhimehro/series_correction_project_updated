...
description: "Skill for the Tests area of series_correction_project_updated. 170 symbols across 28 files."
---

# Tests

170 symbols | 28 files | Cohesion: 90%
...
| `scripts/tests/test_discontinuity_utils.py`       | test_validate_gap_parameters_invalid_step, test_validate_gap_parameters_negative_missing_points, test_validate_gap_parameters_normal_step_none, test_validate_gap_parameters_valid, test_validate_gap_parameters_zero_missing_points (+9)                         |
...
| `scripts/discontinuity_utils.py`                  | _calculate_outlier_z_scores, _validate_gap_parameters, _calculate_normal_step, _generate_missing_times, _is_valid_step                                                                                                                                            |
