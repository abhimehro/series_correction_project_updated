...
This is a placeholder of the project guidelines for Junie. Replace this text
with any project-level instructions for Junie, e.g.:

- What is the project structure
- Whether Junie should run tests to check the correctness of the proposed
  solution
